...
// GET /api/routes-b/invoices/[id]/history — paginated invoice change history.
//
// Backed by the existing AuditEvent log (see lib/audit.ts). Scoped to
// invoices owned by the authenticated user.
//
...
export async function GET(
  ...
  try {
    ...
    logger.error({ err: error }, 'GET /api/routes-b/invoices/[id]/history error')
